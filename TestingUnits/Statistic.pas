...
var
  ...
  numberColumn, lengthPolynomSystem, numberRoot, maxStep : integer;
  timeParser, timeConstractingFullSys, timeConstractingSignTable, timeFormulae,  timeAll : TDateTime;
...
procedure numRoot(k : integer);
procedure StepMax(k : integer);
procedure resultA(l : boolean);



procedure firstFullSys;
procedure closeFullSys;

procedure firstSignTable;
procedure closeSignTable;

procedure firstParser;
procedure closeParser;

procedure firstFormulae;
procedure closeFormulae;
...
{  numberColumn, lengthPolynomSystem, numberRoot, maxStep : integer;
  ...
  timeConstractingFullSys, timeConstractingSignTable : TDateTime;}
...
procedure firstFullSys;
begin
  timeConstractingFullSys := Now;
end;
procedure closeFullSys;
begin
  TimeConstractingFullSys := Now - TimeConstractingFullSys;
end;
...
procedure firstSignTable;
begin
  timeConstractingSignTable := Now;
end;
procedure closeSignTable;
begin
  TimeConstractingSignTable := Now - TimeConstractingSignTable;
end;
...
begin
  ...
  timeParser := 0;
  timeConstractingFullSys :=0;
  timeConstractingSignTable := 0;
  timeFormulae := 0;
  timeAll := 0;

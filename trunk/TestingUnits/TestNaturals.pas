...
var
  ...
  ('test7', '99EE19701C829000', 'A767', '99EE19701C833767'),
  ('test8', 'F34ACFED', '20FE6A7C365AE014', '20FE6A7D29A5B001')
  );
  ...
  ('test8', '7584094756574837', 'A0CB', '+','758409475656A76C'),
  ('test9', '0AD67EF0', '07AF400956CCD758', '-',  '07AF40094BF65868')
  );

  TestsDataMult : TestsMultData = (
  ('test1', '2D356B89', '2686E10D', '06CDBFAADEEFDEF5'),
  ('test2', '2686E10D', '2D356B89', '06CDBFAADEEFDEF5'),
  ('test3', '000000000000', '16D2670EFA67B89A', '0000'),
  ('test4', '53A65467FAEFD53534DE', '0000', '00000000'),
  ('test5', '00FE4EB2A7EEA0D3', '0037', '36A2E86214448D55'),
  ('test6', '0037', '00FE4EB2A7EEA0D3', '36A2E86214448D55')
  );
